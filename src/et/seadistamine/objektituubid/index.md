...
![Objektitüüp koos parameetrite definitsioonidega](/screenshots/et/objektituup.png)
...
Iga tüübi kirjelduse ja kasutajaliidese käitumise kohta vaata [Parameetrid → Parameetrite tüübid](/et/ulevaade/parameetrid/#parameetrite-tuubid).
...
| Parameeter | Kirjeldus |
|---|---|
| `_sharing` | Lubab ja piirab parameetrite projitseerimist selle tüübi jaoks: pole seatud (vaikimisi — domain/public projekteerimine puudub), `private` (piiramine puudub), `domain` või `public`. Vaata [Objektid → Jagamine](/et/ulevaade/objektid/#jagamine). |
...
::: tip
Täieliku töönäite saamiseks objektitüübist koos parameetritega vaata [Kasutusnäited](/et/kasutusnaited/).
:::
