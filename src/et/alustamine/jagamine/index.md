---
description: "Jaga oma Entu andmeid pere või kolleegidega — kutsu inimesi e-postiga ja määra täpselt, mida igaüks näha või muuta saab."
---
...
![Objekti õiguste paneel juurdepääsutasemete ja kasutajakirjetega](/screenshots/et/oigused.png)

## Mida keegi teha saab

Iga kirje (või terve kirjete haru) juures võib inimene olla:

- **Vaataja** — näeb, aga ei muuda. Sobib pereliikmetele või juhtkonnale.
- **Toimetaja** — näeb ja saab sisu muuta.
- **Omanik** — täielik kontroll, sh kustutamine ja teiste juurdepääsu haldamine.

On ka vahepealne tase (**laiendaja**), mis lubab kellelgi sinu kirjete alla uusi lisada olemasolevaid muutmata — mugav ühiste kogude puhul.

## Õigused määratakse igal kirjel
