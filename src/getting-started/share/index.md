---
description: "Share your Entu data with family or colleagues — invite people by email and choose exactly what each person can see or edit."
---
...
For any entry (or a whole branch of entries), a person can be a:

- **Viewer** — can look, can't touch. Good for family members or management.
- **Editor** — can view and change the content.
- **Owner** — full control, including deleting and managing other people's access.

There's also an in-between level (**expander**) that lets someone add new entries under yours without changing the existing ones — handy for shared collections.

## Rights are set per entry
